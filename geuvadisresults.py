##Detect outliers amongst entire population in given data set. 
##After finding the outliers for each gene, you select a few genes ( a few rows in the geuvadis data) 
##and plot the distribution of that gene, 
##meaning a histogram or box plot of the expression values of that gene 
##from all individuals. You can also count the number of outlier genes per
##individual and make a distribution plot from that.
